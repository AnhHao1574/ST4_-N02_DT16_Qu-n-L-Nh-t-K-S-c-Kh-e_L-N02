...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.NhatKy_btn_1 = QtWidgets.QPushButton(self.icon_only_widget)
        self.NhatKy_btn_1.setText("")
        icon = QtGui.QIcon()
        ...
        self.NhatKy_btn_1.setIcon(icon)
        self.NhatKy_btn_1.setIconSize(QtCore.QSize(20, 20))
        self.NhatKy_btn_1.setCheckable(True)
        self.NhatKy_btn_1.setAutoExclusive(True)
        self.NhatKy_btn_1.setObjectName("NhatKy_btn_1")
        self.verticalLayout.addWidget(self.NhatKy_btn_1)
        self.HoSo_btn_1 = QtWidgets.QPushButton(self.icon_only_widget)
        self.HoSo_btn_1.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/icon/group-32.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(":/icon/icon/group-48.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.HoSo_btn_1.setIcon(icon1)
        self.HoSo_btn_1.setIconSize(QtCore.QSize(20, 20))
        self.HoSo_btn_1.setCheckable(True)
        self.HoSo_btn_1.setAutoExclusive(True)
        self.HoSo_btn_1.setObjectName("HoSo_btn_1")
        self.verticalLayout.addWidget(self.HoSo_btn_1)
        self.ThongKe_btn_1 = QtWidgets.QPushButton(self.icon_only_widget)
        self.ThongKe_btn_1.setText("")
        icon2 = QtGui.QIcon()
        ...
        self.ThongKe_btn_1.setIcon(icon2)
        self.ThongKe_btn_1.setIconSize(QtCore.QSize(20, 20))
        self.ThongKe_btn_1.setCheckable(True)
        self.ThongKe_btn_1.setAutoExclusive(True)
        self.ThongKe_btn_1.setObjectName("ThongKe_btn_1")
        self.verticalLayout.addWidget(self.ThongKe_btn_1)
        self.QuanLyTaiKhoan_btn_1 = QtWidgets.QPushButton(self.icon_only_widget)
        self.QuanLyTaiKhoan_btn_1.setText("")
        icon3 = QtGui.QIcon()
        ...
        self.QuanLyTaiKhoan_btn_1.setIcon(icon3)
        self.QuanLyTaiKhoan_btn_1.setIconSize(QtCore.QSize(20, 20))
        self.QuanLyTaiKhoan_btn_1.setCheckable(True)
        self.QuanLyTaiKhoan_btn_1.setAutoExclusive(True)
        self.QuanLyTaiKhoan_btn_1.setObjectName("QuanLyTaiKhoan_btn_1")
        self.verticalLayout.addWidget(self.QuanLyTaiKhoan_btn_1)
        ...
        self.NhatKy_btn_2 = QtWidgets.QPushButton(self.full_menu_widget)
        self.NhatKy_btn_2.setIcon(icon)
        self.NhatKy_btn_2.setIconSize(QtCore.QSize(14, 14))
        self.NhatKy_btn_2.setCheckable(True)
        self.NhatKy_btn_2.setAutoExclusive(True)
        self.NhatKy_btn_2.setObjectName("NhatKy_btn_2")
        self.verticalLayout_2.addWidget(self.NhatKy_btn_2)
        self.HoSo_btn_2 = QtWidgets.QPushButton(self.full_menu_widget)
        self.HoSo_btn_2.setIcon(icon1)
        self.HoSo_btn_2.setIconSize(QtCore.QSize(14, 14))
        self.HoSo_btn_2.setCheckable(True)
        self.HoSo_btn_2.setAutoExclusive(True)
        self.HoSo_btn_2.setObjectName("HoSo_btn_2")
        self.verticalLayout_2.addWidget(self.HoSo_btn_2)
        self.ThongKe_btn_2 = QtWidgets.QPushButton(self.full_menu_widget)
        self.ThongKe_btn_2.setIcon(icon2)
        self.ThongKe_btn_2.setIconSize(QtCore.QSize(14, 14))
        self.ThongKe_btn_2.setCheckable(True)
        self.ThongKe_btn_2.setAutoExclusive(True)
        self.ThongKe_btn_2.setObjectName("ThongKe_btn_2")
        self.verticalLayout_2.addWidget(self.ThongKe_btn_2)
        self.QuanLyTaiKhoan_btn_2 = QtWidgets.QPushButton(self.full_menu_widget)
        self.QuanLyTaiKhoan_btn_2.setIcon(icon3)
        self.QuanLyTaiKhoan_btn_2.setIconSize(QtCore.QSize(14, 14))
        self.QuanLyTaiKhoan_btn_2.setCheckable(True)
        self.QuanLyTaiKhoan_btn_2.setAutoExclusive(True)
        self.QuanLyTaiKhoan_btn_2.setObjectName("QuanLyTaiKhoan_btn_2")
        self.verticalLayout_2.addWidget(self.QuanLyTaiKhoan_btn_2)
        ...
        self.NhatKy_btn_1.toggled['bool'].connect(self.NhatKy_btn_2.setChecked) # type: ignore
        self.ThongKe_btn_1.toggled['bool'].connect(self.ThongKe_btn_2.setChecked) # type: ignore
        self.QuanLyTaiKhoan_btn_1.toggled['bool'].connect(self.QuanLyTaiKhoan_btn_2.setChecked) # type: ignore
        self.products_btn_1.toggled['bool'].connect(self.products_btn_2.setChecked) # type: ignore
        self.HoSo_btn_1.toggled['bool'].connect(self.HoSo_btn_2.setChecked) # type: ignore
        self.NhatKy_btn_2.toggled['bool'].connect(self.NhatKy_btn_1.setChecked) # type: ignore
        self.ThongKe_btn_2.toggled['bool'].connect(self.ThongKe_btn_1.setChecked) # type: ignore
        self.QuanLyTaiKhoan_btn_2.toggled['bool'].connect(self.QuanLyTaiKhoan_btn_1.setChecked) # type: ignore
        self.products_btn_2.toggled['bool'].connect(self.products_btn_1.setChecked) # type: ignore
        self.HoSo_btn_2.toggled['bool'].connect(self.HoSo_btn_1.setChecked) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Quản lý nhật ký sức khỏe"))
        self.logo_label_3.setText(_translate("MainWindow", "QUẢN LÝ NHẬT KÝ SỨC KHỎE"))
        self.NhatKy_btn_2.setText(_translate("MainWindow", "Nhật ký sức khỏe "))
        self.HoSo_btn_2.setText(_translate("MainWindow", "Hồ sơ sức khỏe"))
        self.ThongKe_btn_2.setText(_translate("MainWindow", "Thống kê"))
        self.QuanLyTaiKhoan_btn_2.setText(_translate("MainWindow", "Quản lý tài khoản "))
        self.products_btn_2.setText(_translate("MainWindow", "Khác"))
        self.exit_btn_2.setText(_translate("MainWindow", "Exit"))
        self.search_input.setPlaceholderText(_translate("MainWindow", "Search..."))
from utils import resource_rc
